...
export default function Footer() {
  ...
  return (
      ...
      >
        <div className="w-full md:w-1/2 flex flex-col md:flex-row items-center justify-center md:justify-start px-8 mb-6 md:mb-0">
          <img
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start px-8">
          <div className="w-full mb-6">
            ...
            <div className="flex items-center mb-3">
              ...
              <a
                  className="break-words hover:text-teal-400 transition-colors duration-200"
